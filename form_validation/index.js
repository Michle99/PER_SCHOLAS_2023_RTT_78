// Step 1: Wrap your code in the DOMContentLoaded event to ensure HTML is fully loaded.
document.addEventListener('DOMContentLoaded', function () {
    // Step 2: Get references to the registration and login forms in the DOM.
    const registrationForm = document.getElementById('registration');
    const loginForm = document.getElementById('login');
  
    // Step 3: Add a submit event listener to the registration form.
    registrationForm.addEventListener('submit', function (event) {
      event.preventDefault(); // Prevent the default form submission.
  
      // Step 4: Implement Registration Form Validation.
      ...
      if (usernameValid && emailValid && passwordValid && termsAccepted) {
        ...
        // Clear form fields and show a success message using an alert.
        registrationForm.reset();
        alert('Registration successful!');
      } else {
        // Display an error message using an alert.
        alert('Registration failed. Please check the form fields.');
      }
    });
  
    // Step 5: Implement Validation Functions for Registration.
    // (Include the functions as previously provided)
    ...
    // Step 8: Implement Display Functions for Success and Error Messages.
